            ...
            <div className="w-1/5 gradient shadow sm:p-1 md:p-1 mx-5 mb-24 rounded-3xl">
              <div className="w-full p-5 bg-black sm:p-6 md:p-8 rounded-3xl">
                <p className="text-sm">
                  ...
                  Consequatur, soluta. Corrupti, doloribus quis vel officia
                  temporibus totam necessitatibus amet cumque expedita illo
                  excepturi eum sit fugiat mollitia, hic quaerat quisquam?
                </p>
              </div>
            </div>
        ...
        <section id="team" className="pt-36 mb-36">
          ...
          <div className="flex justify-center w-full  flex-row sm:mt-10 pt-8">
            <a
              ...
              target={"_blank"}
              className="w-1/3 max-w-sm p-10 rounded-lg shadow sm:p-6 md:p-8 mx-5"
            >
              <img
            ...
            <a
              ...
              target={"_blank"}
              className="w-1/3 max-w-sm p-10 sm:p-6 md:p-8 mx-5"
            >
              <img
