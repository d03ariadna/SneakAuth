            ...
            <section id="StaticsPage">
              ...
              <div className="flex justify-center">
                ...
                <div className="w-[514px] h-[314px] flex items-center">
                  <h1 className="mb-1 ml-10 font-outf text-6xl">
              ...
              <div className="flex justify-center mt-24">
                <div className="w-[514px] h-[314px] flex items-center">
                  <h1 className="mb-1 mr-10  font-outf text-6xl">
                    Counterfeit Shoe Market
                  </h1>
                </div>
                <div className="w-[514px] h-[314px] relative">
                  <div className="w-[500px] h-[300px] bg-[#262626] rounded-xl absolute right-0 bottom-0"></div>
                  <div className="bg-gradient-to-r from-purplemain to-orange w-[500px] h-[300px] rounded-xl absolute flex items-center top-0 left-0">
                    <h1 className="mb-1 mx-16 font-bold text-3xl">
        ...
        <section id="signUp">
          ...
          <form className="w-full mt-10 mb-20">
            <div className="flex items-center py-2">
              ...
              <button className="flex-shrink-0 bg-white text-black shadow-md hover:bg-gradient-to-r from-bluemain to-purplemain font-bold hover:text-white py-4 px-8 rounded-2xl" type="button">
                Sign Up
              </button>
            </div>
          </form>
